...
class  AddCut  extends  Component{
	...
	render(){
	   ...
	   return  (<View className="addcut">
	   	<Image  onClick={this.CutFood.bind(this)} className={"opeate_img "+hideClass} src={require('../../assets/imgs/cut.png')}></Image>
	   	<Text className={"food_num "+hideClass}>{Num}</Text>
	   	<Image onClick={this.AddFood.bind(this)} className="opeate_img" src={require('../../assets/imgs/add.png')}></Image>
	   </View>)
	}
}
